...
wbr4_karvy='203WBCUM35722083s.csv' #name of sheet at WBR/CAMPS/
...
directory_of_wbr4_karvy_file=(os.getcwd()+'/WBR/karvy/'+wbr4_karvy)
wbr4_karvy_csv_file=open(directory_of_wbr4_karvy_file,mode='r',encoding='mac_roman',newline='')
reader_wbr4=csv.reader(wbr4_karvy_csv_file)
for row in reader_wbr4:
	if row[30]==pannumber:
		print(row[2],row[4])
		client_folio_and_amc.append([client_name,pannumber,row[2],row[4]])
#print(client_folio_and_amc)
wbr4_karvy_csv_file.close()
